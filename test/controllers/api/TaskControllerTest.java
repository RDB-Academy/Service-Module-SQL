...
public class TaskControllerTest extends WithServer {
    ...
    public void TaskControllerCreate() throws Exception {
        ...
        CompletionStage<WSResponse> completionStage = wsClient.url(routes.TaskController.create().url()).post(task);
        WSResponse response = completionStage.toCompletableFuture().get();
    }

    @Test
    public void TaskControllerView() throws Exception {
        CompletionStage<WSResponse> completionStage = wsClient.url(routes.TaskController.view().url()).get();
        WSResponse response = completionStage.toCompletableFuture().get();
