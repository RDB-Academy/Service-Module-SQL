package sqlParser.sqlTrainerService.generators;
...
public class ExtensionMaker {
    ...
    public List<String> buildStatements() {
        ...
        for (TableDef tableDef : schemaDef.getTableDefList()) {
            ...
            entityList.forEach((temp) -> usedIdList.add(temp.get("id")));
    ...
    private String gen(String[] field){
